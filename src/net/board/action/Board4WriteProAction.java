...
public class Board4WriteProAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		boolean isWriteSuccess = boardWriteProService.registArticle(boardBean, "board4");
