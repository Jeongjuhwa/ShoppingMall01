		...
		<tr>
			<td colspan=2>
				...
				<form action="./MemberModifyAction_2.me" method="post"
					name="infoform" onsubmit="return check(this)">
					<table border="1" width="80%" height="80%">
						...
						<tr>
							<td bgcolor="#f5f5f5"><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;ID</font>
							</td>
						...
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp; ${member.MEMBER_JUMIN1 } -
								${member.MEMBER_JUMIN2}</td>
						</tr>
						<tr>
							<td bgcolor="#f5f5f5"><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;이메일
									주소</font></td>
							<td>&nbsp;&nbsp;&nbsp; <input type="text"
								name="MEMBER_EMAIL1" size="13" value="<%=email[0].trim()%>" />
						...
						<tr>
							<td bgcolor="#f5f5f5"><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;메일
									수신 여부</font></td>
							<td>&nbsp;&nbsp;&nbsp; <input type="radio"
								name="MEMBER_EMAIL_GET" value="YES"
								<%if (MEMBER_EMAIL_GET.equals("YES")) {%> checked <%}%> /> <font
								size="2">수신</font> &nbsp;&nbsp; <input type="radio"
								name="MEMBER_EMAIL_GET" value="NO"
								<%if (MEMBER_EMAIL_GET.equals("NO")) {%> checked <%}%> /> <font
								size="2">수신 안함</font>
							</td>
						</tr>
						<tr>
							<td bgcolor="#f5f5f5"><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;집
									전화</font></td>
							<td>&nbsp;&nbsp;&nbsp; <input type="text"
								name="MEMBER_PHONE" size="24" value="${member.MEMBER_PHONE }" />
							</td>
						</tr>
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp; <input type="text"
								...
								maxlength="3" value="<%=zipcodes[0].trim()%>" /> - <input
								type="text" name="MEMBER_ZIPCODE2" size="6"
								onkeypress="gNumCheck()" maxlength="3"
								value="<%=zipcodes[1].trim()%>" />&nbsp;&nbsp; <input
						...
						<tr>
							<td bgcolor="#f5f5f5"><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;집
									주소</font></td>
							<td>&nbsp;&nbsp;&nbsp; <input type="text"
								name="MEMBER_ADDR1" size="50" value="${member.MEMBER_ADDR1 }" />
							</td>
						</tr>
						<tr>
							<td bgcolor="#f5f5f5"><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;상세
									주소</font></td>
							<td>&nbsp;&nbsp;&nbsp; <input type="text"
								name="MEMBER_ADDR2" size="50" value="${member.MEMBER_ADDR2 }" />
							</td>
						</tr>
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp; <input type="text"
								name="MEMBER_MOBILE" size="24" value="${member.MEMBER_MOBILE }" />
							</td>
						</tr>
					</table>
					...
					<table width="80%">
						<tr>
							<td align="center"><br />
							<input type="submit" value="회원정보 수정" /> <input type="button"
								value="회원 탈퇴" name="bt" onclick="out()" /></td>
						</tr>
					</table>
				</form> <!-- 개인정보 수정 -->
			</td>
