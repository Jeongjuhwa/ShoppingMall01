...
<body>
 ...
 %> <a
						href="board4Detail.bo?board_num=<%=articleList.get(i).getBOARD_NUM()%>&page=<%=nowPage%>">
		...
		<section id="pageList">
			...
			%>
			<a href="board4List.bo?page=<%=nowPage - 1%>">[이전]</a>&nbsp;
			<%
				}
			%>
			...
			%>
			<a href="board4List.bo?page=<%=nowPage + 1%>">[다음]</a>
			<%
				}
			%>
		</section>
		...
		%>
		<p>
			<a href="board4WriteForm.bo">게시판글쓰기</a>
		</p>
	</div>
</body>
</html>
